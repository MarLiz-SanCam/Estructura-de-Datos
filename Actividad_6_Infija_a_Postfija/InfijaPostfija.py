# pasar de una expresión aritmética en notación Infija (A+B)*(C-D) a notación Postfija AB+CD-* utilizando la estructura de datos tipo pila. Respetando la jerarquía de los operadores aritméticos: 
# Paréntesis ( )
# Exponenciación ^
